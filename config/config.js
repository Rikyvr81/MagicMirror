let config = {
	...
	modules: [
		...
		},
		{
			...
			config: {
				updateInterval: 300000,
				text: "<div class='second-family-calendar-frame'><iframe  src='https://calendar.google.com/calendar/embed?src=it.italian%23holiday@group.v.calendar.google.com&color=%230B8043&ctz=Europe/Rome&month=next&showTitle=0&showNav=0&showDate=0&showPrint=0&showTabs=0&showCalendars=0&showTz=0' style='border:0' width:'450' height:'450' frameborder='0' scrolling='no'></iframe></div>",
			}
		},		
